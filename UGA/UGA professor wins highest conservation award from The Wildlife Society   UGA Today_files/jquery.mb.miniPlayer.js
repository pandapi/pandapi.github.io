    ...
    buildPlayer:function(options){
      ...
      this.each(function(){
        ...
        $player.jPlayer({
          ready: function () {
            ...
            $playBox.toggle(
                    function(){
                      ...
                      $controls.css({display:"block",height:13}).animate({width:player.opt.width},200);
                      ...
                      if(player.opt.showVolumLevel) {
                        if(isIE)
                          ...
                          $volumeLevel.show().animate({width:30},100);
                        if($.browser.safari)$volumeLevel.parent().css({width:30}).show();
                      }
            ...
            $volumeLevel.find("a").each(function(i){
              $(this).css({opacity:.3, height:1+2*(i+1), width:Math.floor(20/bars)});
              $(this).click(function(){
          ...
          $volumeLevel.find("a").css({opacity:.4}).removeClass("sel");
          for (var i=0;i<=IDX;i++){
